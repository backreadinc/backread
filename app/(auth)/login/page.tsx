  ...
  return (
    <div style={{ width: '100%', maxWidth: 400 }}>
      <div style={{ textAlign: 'center', marginBottom: 32 }}>
        <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 32, color: '#1C1917', margin: '0 0 8px', letterSpacing: '-0.02em' }}>Welcome back</h1>
        <p style={{ fontSize: 15, color: '#6B6559', margin: 0 }}>Sign in to your Folio account</p>
      </div>
      ...
      <div style={{ background: 'white', border: '1px solid #E5E0D8', borderRadius: 16, padding: '32px' }}>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Button variant="primary" type="submit" loading={loading} size="lg" style={{ width: '100%' }}>Sign in</Button>
        </form>
      </div>

      <p style={{ textAlign: 'center', fontSize: 14, color: '#6B6559', marginTop: 20 }}>
        Don&apos;t have an account?{' '}
        <Link href="/signup" style={{ color: '#DC6B19', fontWeight: 500, textDecoration: 'none' }}>Create one free</Link>
      </p>
    </div>
  )
}
